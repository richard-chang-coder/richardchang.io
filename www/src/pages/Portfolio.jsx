    ...
    return (
        <PageTransition>
            <PortfolioHeader>
                <Grid container spacing={12}>
                    <Grid item xs={12} sm={8}>
                        <PortfolioTitle variant="h2" component="h1" sx={{textTransform: 'uppercase'}}>{portfolio.title}</PortfolioTitle>
                        <Typography variant='body1' sx={{mb: 3}}>{portfolio.description}</Typography>
                        <Button variant="contained" size="xlarge" onClick={() => window.open(`${portfolio.url}`, '_blank')}>View Project</Button>
                    </Grid>
                    <PortfolioDetail item xs={12} sm={4}>
                        <Grid item xs={12} sm={6}>
                            <Typography variant='body1' as="h5">Client</Typography>
                            <ul>
                                <li>Myself</li>
                            </ul>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                            <Typography variant='body1' as="h5">My Role</Typography>
                            <ul>
                                <li>UX</li>
                            </ul>
                            </Grid>
                        <Grid item xs={12} sm={6}>
                            <Typography variant='body1' as="h5">Year</Typography>
                            <ul>
                                <li>2018</li>
                            </ul>
                        </Grid>
            ...
            <PortfolioHeroImage maxWidth={false}>
                ...
                <img  src={process.env.PUBLIC_URL + '/mock-up.jpg'} alt="Dynamic Funds"/>
            </PortfolioHeroImage>
